...
* [Get-InstalledSoftware](Module/LazyAdmin/Get-InstalledSoftware.ps1) - Get all installed software with DisplayName, UninstallString etc. ([view documentation](Documentation/Get-InstalledSoftware.README.md))
...
* [Get-InstalledSoftware.ps1](Scripts/Get-InstalledSoftware.ps1) - Get all installed software with DisplayName, UninstallString etc. ([view documentation](Documentation/Get-InstalledSoftware.README.md))
