...
<#
    ...
    .DESCRIPTION
    Rotate ascii chars by n places (Caesar cipher). You can encrypt with the parameter "-Encrypt" or decrypt with the parameter "-sDecrypt", depens on what you need. Decryption is selected by default.

    Try the parameter "-UseAllAsciiChars" if you have a string with umlauts which e.g. exist in the German language. 

    .EXAMPLE
    Convert-ROT47 -Text "This is an encrypted string!" -Rot 7
    ...
    .EXAMPLE
    Convert-ROT47 -Text "Beispiel: Cäsar-Verschlüsselung - Sprache Deutsch!" -Rot 3 -Encrypt -UseAllAsciiChars
