...
<#
    ...
    .EXAMPLE
    New-IPv4Scan -StartIPv4Address 192.168.178.0 -EndIPv4Address 192.168.178.20
    ...
    .EXAMPLE
    New-IPv4Scan -IPv4Address 192.168.178.0 -Mask 255.255.255.0 -DisableDNSResolving
    ...
    .EXAMPLE
    New-IPv4Scan -IPv4Address 192.168.178.0 -CIDR 25 -EnableMACResolving
