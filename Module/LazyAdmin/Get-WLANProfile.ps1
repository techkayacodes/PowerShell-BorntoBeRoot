...
# Description  :  Function which returns all WLAN-Profiles, include password as SecureString or as plain text
...
<#
   ...
   .DESCRIPTION
    This function returns all WLAN-Profiles, on your local system, as custom PowerShell-Object, include SSID, 
