...
* [view function](https://github.com/BornToBeRoot/PowerShell/blob/master/Module/LazyAdmin/Network/New-IPv4Scan.ps1)
* [view script](https://github.com/BornToBeRoot/PowerShell/blob/master/Scripts/Network/New-IPv4Scan.ps1)
...
![Screenshot](Images/New-IPv4Scan.png?raw=true "New-IPv4Scan")
...
![Screenshot](Images/New-IPv4Scan_CPUusage.png?raw=true "CPU usage")
...
```powershell
New-IPv4Scan [-StartIPv4Address] <IPAddress> [-EndIPv4Address] <IPAddress> [[-Tries] <Int32>] [[-Threads] <Int32>] [[-DisableDNSResolving]] [[-EnableMACResolving]] [[-ExtendedInformations]] [[-IncludeInactive]] [[-UpdateList]] [<CommonParameters>]

New-IPv4Scan [-IPv4Address] <IPAddress> [-Mask] <String> [[-Tries] <Int32>] [[-Threads] <Int32>] [[-DisableDNSResolving]] [[-EnableMACResolving]] [[-ExtendedInformations]] [[-IncludeInactive]] [[-UpdateList]] [<CommonParameters>]

New-IPv4Scan [-IPv4Address] <IPAddress> [-CIDR] <Int32> [[-Tries] <Int32>] [[-Threads] <Int32>] [[-DisableDNSResolving]] [[-EnableMACResolving]] [[-ExtendedInformations]] [[-IncludeInactive]] [[-UpdateList]] [<CommonParameters>]
```
...
```powershell
PS> New-IPv4Scan -StartIPv4Address 192.168.178.0 -EndIPv4Address 192.168.178.20
...
PS> New-IPv4Scan -IPv4Address 192.168.178.0 -Mask 255.255.255.0 -DisableDNSResolving
